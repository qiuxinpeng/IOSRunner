 ...
 *
 */
#define HANZI_START_Q 19968
#define HANZI_COUNT_Q 20902


static char QfirstLetterArray[HANZI_COUNT_Q] =
...
{
	int index = hanzi - HANZI_START_Q;
	if (index >= 0 && index <= HANZI_COUNT_Q)
	{
		return QfirstLetterArray[index];
	}
	else
	{
		return hanzi;
