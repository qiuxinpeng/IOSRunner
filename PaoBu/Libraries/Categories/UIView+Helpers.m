...
static inline UIImage* createRoundedCornerMask(CGRect rect, CGFloat radius_tl, CGFloat radius_tr, CGFloat radius_bl, CGFloat radius_br)
{
    ...
    context = CGBitmapContextCreate( NULL, rect.size.width, rect.size.height, 8, 0, colorSpace, kCGBitmapByteOrderDefault );
...
- (UIImageView *)createSnapshot
{
    ...
    __autoreleasing UIImageView *snapshot = [[UIImageView alloc] initWithImage:image];
    [snapshot setFrame:[self frame]];
    
    return  snapshot;
}
- (UIImage *)createSnapshotImage{
