//
//  ActionSheetPickerMiNiDelegate.m
//  SiFaKaoShi
//
//  Created by XiaoBai on 14-3-26.
...
- (void)actionSheetPickerDidSucceed:(AbstractActionSheetPicker *)actionSheetPicker origin:(id)origin
{
    ...
    */
    ...
    int oneRow=[tempPiker selectedRowInComponent:0]==-1?0:[tempPiker selectedRowInComponent:0];
    int twoRow=[tempPiker selectedRowInComponent:1]==-1?0:[tempPiker selectedRowInComponent:1];
    tempPiker=nil;
