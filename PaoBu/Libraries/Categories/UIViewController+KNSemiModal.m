...
-(void)dismissSemiModalViewFromSender:(id)sender{
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"qxpSemiModelViewDismissNotification" object:sender];
